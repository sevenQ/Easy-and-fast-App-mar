...
public class Main extends Activity implements OnItemClickListener {
	...
	private void initList() {
		...
		pi_list = getPackageManager().getInstalledPackages(
	...
	/*
	//load label name;
	Runnable labelHandler = new Runnable() {

		@Override
		public void run() {
			android.os.Process.setThreadPriority(android.os.Process.myTid(),-13);
			
			LogHelper.d(TAG + " label start: " + System.currentTimeMillis() );
			for (int i = 0; i < listSize; i++) {
				
			}
			LogHelper.d(TAG + " label end: " + System.currentTimeMillis() );
		}
	};
	*/
	//load packName and times
